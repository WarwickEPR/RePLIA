...
proc init_gui { IPINST } {
  ...
  set ADDR_WIDTH [ipgui::add_param $IPINST -name "ADDR_WIDTH" -parent ${Page_0}]
  set_property tooltip {Width of the address.} ${ADDR_WIDTH}
  ...
  set AXI_ID_WIDTH [ipgui::add_param $IPINST -name "AXI_ID_WIDTH" -parent ${Page_0}]
  set_property tooltip {Width of the AXI ID bus.} ${AXI_ID_WIDTH}
