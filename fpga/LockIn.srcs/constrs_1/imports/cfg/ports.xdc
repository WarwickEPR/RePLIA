...
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports daisy_p_o0]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports daisy_n_o0]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports daisy_p_o1]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports daisy_n_o1]

set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports daisy_p_i0]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports daisy_n_i0]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports daisy_p_i1]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports daisy_n_i1]

set_property PACKAGE_PIN T12 [get_ports {daisy_p_o0}]
set_property PACKAGE_PIN U12 [get_ports {daisy_n_o0}]

set_property PACKAGE_PIN U14 [get_ports {daisy_p_o1}]
set_property PACKAGE_PIN U15 [get_ports {daisy_n_o1}]

set_property PACKAGE_PIN P14 [get_ports {daisy_p_i0}]
set_property PACKAGE_PIN R14 [get_ports {daisy_n_i0}]

set_property PACKAGE_PIN N18 [get_ports {daisy_p_i1}]
set_property PACKAGE_PIN P19 [get_ports {daisy_n_i1}]
